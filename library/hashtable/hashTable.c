...
int getCurrentIndex(HashTable* table, int currentIndex, int currentNumberOfProbes)
{
    return (currentIndex + (currentNumberOfProbes + currentNumberOfProbes * currentNumberOfProbes) / 2) % table->bucketCount;
}
